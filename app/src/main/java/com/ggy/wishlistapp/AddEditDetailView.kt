...
import com.ggy.wishlistapp.data.Wish
        ...
        Column(
            ...
            Button(
                ...
                colors = ButtonDefaults.buttonColors(
                    backgroundColor = colorResource(id = R.color.app_var_color)
                ),
            ) {
                Text(
                    ...
                    modifier = Modifier.background(colorResource(id = R.color.app_var_color))
                )
            }
        }
    }
